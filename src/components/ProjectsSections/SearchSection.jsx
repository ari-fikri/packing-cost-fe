      ...
      <div className="row">
        ...
        <div className="col-12 col-md-6">
          <div className="form-group">
            ...
            <div className="input-group input-group-sm">
              <input value={code} onChange={e => setCode(e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter') { e.preventDefault(); handleSearch(); } }} className="form-control form-control-sm" placeholder="Code" />
        ...
        <div className="col-12 col-md-6">
          <div className="form-group">
            ...
            <div className="input-group input-group-sm">
              <input value={name} onChange={e => setName(e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter') { e.preventDefault(); handleSearch(); } }} className="form-control form-control-sm" placeholder="Project name" />
              <div className="input-group-append">
      ...
      <div className="row">
        ...
        <div className="col-12 col-md-6">
          <div className="form-group">
            ...
            <div className="input-group input-group-sm">
              <input value={models} onChange={e => setModels(e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter') { e.preventDefault(); handleSearch(); } }} className="form-control form-control-sm" placeholder="Model code / name" />
              <div className="input-group-append">
        ...
        <div className="col-12 col-md-6">
          <div className="form-group">
            ...
            <div className="input-group input-group-sm">
              <input value={manager} onChange={e => setManager(e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter') { e.preventDefault(); handleSearch(); } }} className="form-control form-control-sm" placeholder="Manager name" />
              <div className="input-group-append">
